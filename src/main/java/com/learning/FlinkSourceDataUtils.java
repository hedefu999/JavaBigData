...
public class FlinkSourceDataUtils {
    public static List<PageEvent> PAGEEVENTS = Arrays.asList(
            PageEvent.createPageEvent("jack","a01","2022-01-03 12:12:15","buy", 20),
            PageEvent.createPageEvent("jack","a01","2022-01-03 12:15:15", "view",2),
            PageEvent.createPageEvent("lucy","a02","2022-01-03 12:17:00", "scroll",3),
            PageEvent.createPageEvent("jack","a02", "2022-01-03 12:18:00", "lucymoney", -2)
    );
